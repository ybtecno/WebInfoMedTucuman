...
$(function() {
  ...
  $('.resumen-evento li:nth-child(1) p').animateNumber({ number: 600}, 1500);
  $('.resumen-evento li:nth-child(2) p').animateNumber({ number: 150}, 1500);
  $('.resumen-evento li:nth-child(3) p').animateNumber({ number: 220}, 1500);
  $('.resumen-evento li:nth-child(4) p').animateNumber({ number: 350}, 1500);
